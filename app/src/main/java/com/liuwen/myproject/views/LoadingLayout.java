...
public class LoadingLayout extends FrameLayout {
    ...
    public static class Config {
        ...
        int reloadBtnId = R.drawable.selector_btn_bg;
        int tipTextSize = 14;
        int buttonTextSize = 14;
        int tipTextColor = R.color.colorBaseTextLight;
        int buttonTextColor = R.color.colorBaseTextLight;
        int buttonWidth = -1;
        int buttonHeight = -1;
        int loadingLayoutId = R.layout.widget_loading_page;
        View loadingView = null;
        int backgroundColor = R.color.colorBaseLoadingBg;
