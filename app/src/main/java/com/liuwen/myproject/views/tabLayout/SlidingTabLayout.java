package com.liuwen.myproject.views.tabLayout;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
     ...
     * @param string
     */
    public void setFlag(int currentTab, String string) {

        for (int i = 0; i < mTabCount; i++) {
            View v = mTabsContainer.getChildAt(i);
            TextView tv_tab_flag = (TextView) v.findViewById(R.id.tv_tab_flag);
            LinearLayout ll_tab_flag = (LinearLayout) v.findViewById(R.id.ll_tab_flag);
            if (tv_tab_flag != null) {
                if (currentTab == i) {
                    if (!string.equals("0")) {
                        ll_tab_flag.setVisibility(View.VISIBLE);
                        tv_tab_flag.setText(string);
                    } else if (string.equals("0") || string.equals("")) {
                        ll_tab_flag.setVisibility(View.INVISIBLE);
                    }
                }
            }
        }
